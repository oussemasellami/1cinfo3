...
class ClassroomController extends AbstractController
{
    ...
    #[Route('/showclassroomstudent/{id}', name: 'app_showclassroomstudent', methods: ['GET'])]
    public function showclassroomstudent($id, ClassroomRepository $classroomRepository): Response
    {
        $classroom = $classroomRepository->showclassroomstudent($id);
